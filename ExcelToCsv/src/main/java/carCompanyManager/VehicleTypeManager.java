...
public class VehicleTypeManager {
	...
	public static void main(String[] args) {
		...
		List<VehicleType> vehicleTypes = new LinkedList<>();  //PPT3 Array List to store all Bank Account Objects
		
		VehicleType vehicleType1 = new VehicleType();
		vehicleTypes.add(vehicleType1);
		vehicleType1.setCarModel("SUV");
		List<String> addresses = List.of("124 Mulberry St.", "109 Cherry St.");
		vehicleType1.setAddresses(addresses);
		vehicleType1.mapAdd(vehicleType1.getCarModel(), vehicleType1.getAddresses());
